                ...
                <div className="flex">
                    <div className="flex-none w-1/2 space-y-10 sm:space-y-8 lg:flex lg:space-y-0">
                        <div className="lg:flex-none lg:w-1/2">
                            <h2 className="font-semibold text-slate-900 dark:text-slate-100">Начало работы</h2>
                            <ul className="mt-3 space-y-2">
                                {[
                                    ...
                                    <li>
                                        <Link to={url} className="transition-all ease-linear hover:text-slate-900 dark:hover:text-slate-300">{title}</Link>
                                    </li>
                                ))}
                            </ul>
                        </div>
                    ...
                    <div className="flex-none w-1/2 space-y-10 sm:space-y-8 lg:flex lg:space-y-0">
                        <div className="lg:flex-none lg:w-1/2">
                            <h2 className="font-semibold text-slate-900 dark:text-slate-100">Сообщество</h2>
                            <ul className="mt-3 space-y-2">
                                {[
                                    ['Website', '/'],
                                    ['Vk', '/'],
