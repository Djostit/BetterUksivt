    ...
    >
      ...
      <div className="flex items-center">
        ...
        <div className="hidden md:flex items-center">
            ...
            <ul className="flex items-center gap-x-8">
              {[
                ...
                <li>
                  <Link
                    to={url}
                    className="transition-all ease-linear hover:text-sky-500 dark:hover:text-sky-400"
                  >
                    {title}
                  </Link>
                </li>
          ...
          <div className="flex transition-all ease-linear items-center border-l border-slate-200 ml-6 pl-6 dark:border-slate-800">
            <label className="sr-only">Theme</label>
            <button
              type="button"
              onClick={() => document.documentElement.classList.toggle("dark")}
            >
              <span className="transition-all ease-linear dark:hidden">
                <svg
                  viewBox="0 0 24 24"
                  fill="none"
                  stroke-width="2"
              ...
              <span className="hidden transition-all ease-linear dark:inline">
