...
const Navbar = () => {
    return ( 
        <div className="relactive px-4 sm:px-6 md:px-8 pt-6 lg:pt-8 flex items-center justify-between text-slate-700 font-semibold text-sm leading-6 dark:text-slate-200">
            <Link to="/">
               <span className="font-bold text-slate-900 dark:text-slate-200 w-auto h-5">BetterUksivt</span>
            </Link>
                    ...
                    <nav>
                        <ul className="flex items-center gap-x-8">
                            {[
                                ...
                                <li>
                                    <Link to={url} className="transition-all ease-linear hover:text-sky-500 dark:hover:text-sky-400">{title}</Link>
                                </li>
                            ))}
                        </ul>
                    </nav>
                        ...
                        <button type="button" onClick={() => document.documentElement.classList.toggle('dark')}>
                            ...
                            <span className="hidden dark:inline">
                                <svg viewBox="0 0 24 24" fill="none" className="w-6 h-6">
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M17.715 15.15A6.5 6.5 0 0 1 9 6.035C6.106 6.922 4 9.645 4 12.867c0 3.94 3.153 7.136 7.042 7.136 3.101 0 5.734-2.032 6.673-4.853Z" className="fill-sky-400/20"></path>
